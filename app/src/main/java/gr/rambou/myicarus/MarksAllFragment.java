...
public class MarksAllFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public MarksAllFragment() {
        // Required empty public constructor
    }

    public static MarksAllFragment newInstance() {
        MarksAllFragment fragment = new MarksAllFragment();
    ...
    public void onRefresh() {
        ...
        new MarksAllFragment.ReloadGrades().execute();
    }
    ...
    public class ReloadGrades extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                arraylist = myicarus.getAll_Lessons();
